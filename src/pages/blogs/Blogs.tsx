      ...
      >
              ...
              <nav aria-label="breadcrumb-nav">
                <ol className="breadcrumb breadcrumb-style-2 my-20 ">
                  ...
                  >
                    ...
                    {/* </div> */}
                    <div className="mb-10 mb-lg-0" data-wow-delay="0.4s">
                      <Link
                        to={ROUTES.EDITOR}
        ...
        <section className="section-blog-hero pt-70 pb-lg-60 pb-40">
          <div className="blog-wrapper pb-0">
            <div className="container">
              <h2
                className="mb-lg-40 mb-20  wow fadeInUp"
                data-wow-delay="0.4s"
              >
              ...
              <div className="row custom-row-gap">
                      ...
                      >
                        <div className="card-image-wrapper card-image-wrapper-style-2 ">
                          <Link
                            to={ROUTES.ARTICLE.replace(
                              ":articleId",
                              String(top3Blogs[0].id)
                            )}
                          >
                            <img
                              src={top3Blogs[0].mainImage}
                              data-src={top3Blogs[0].mainImage}
                        ...
                        <div className="card-body">
                          ...
                          <p className="card-text small">
                            {top3Blogs[0].introduction.substring(0, 25)}...
                          </p>
                        </div>
                      </Reveal>
                    </div>
                ...
                <div className="col-xxl-6  wow fadeInUp" data-wow-delay="0.4s">
                  {top3Blogs.length > 0 &&
                    top3Blogs.slice(1).map((blog, index) => {
                      return (
                        <Reveal
                        ...
                        >
                          <div
                            className="card card-style-6 align-items-center card-border mb-40 "
                            key={index}
                          >
                            {/* <!-- single-card --> */}
                            ...
                            <div className="card-body p-0">
                              ...
                              <p className="card-text d-lg-block d-none">
        ...
        <section className="section-blog py-30 py-md-60 py-lg-100">
          <div className="container">
            <div className="row custom-row-gap">
              <h4 className="fs-1 mb-40  wow fadeInUp" data-wow-delay="0.4s">
                Latest Article
              </h4>
              <div className="col-lg-8">
                <div className="row custom-row-gap">
                    ...
                    blogs.map((blog, index) => {
                      return (
                        <div className="col-md-6" key={index}>
                          <Reveal
                            keyframes={
                              index % 2 === 0 ? backInLeft : backInRight
                            }
                            duration={1000}
                            triggerOnce
                          >
                            <div
                              className="card card-style-2 card-border mb-lg-40 mb-20  wow RevealInUp"
                              data-wow-delay="0.4s"
                            >
                              <div className="card-image-wrapper">
                                <Link
                  ...
                  <div
                    className="load-more-btn mb-40 mb-lg-0 pt-20 wow fadeInUp"
                    data-wow-delay="0.4s"
                  >
