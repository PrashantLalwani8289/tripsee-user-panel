                                ...
                                <div className="sticky-elements">
                                    ...
                                    <div className="widget mb-lg-60 mb-30">
                                        ...
                                        <div className="d-flex flex-column gap-3 gap-xl-30">
                                            {/* <!-- mini-card-style --> */}
                                            {blogs && !blogsLoading && blogs.slice(0,5).map((blog, index) => {
                                                return (
                                                    <div className="mini-card-style wow fadeInUp" data-wow-delay="0.4s" key={index}>
                                                        <div className="card-image-wrapper">
                                                            <Link to="article-1.html"><img src={blog.mainImage} data-src={blog.mainImage} className="card-img-top" alt="Breakfast" /> </Link>
                                                        </div>

                                                        <div className="card-body">
                                                            <h5 className="card-title lead fw-extrabold mb-0"><Link to="article-1.html" className="blog-title">{blog.title}</Link></h5>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-8">
                                <div className="add-banner">
                                    <Link to="#"><img src="assets/images/add-02.png" alt="add-image" className="border-rarius-14" /></Link>
                                </div>
                            </div>
                        </div>
                    </div>
