                                                ...
                                                return (
                                                    <div className="mini-card-style wow fadeInUp" data-wow-delay="0.4s" key={index}>
                                                        <div className="card-image-wrapper">
                                                            <a href="article-1.html"><img src={blog.mainImage} data-src={blog.mainImage} className="card-img-top" alt="Breakfast" /> </a>
                                                        </div>

                                                        <div className="card-body">
                                                            <h5 className="card-title lead fw-extrabold mb-0"><a href="article-1.html" className="blog-title">{blog.title}</a></h5>
