            ...
            <div className="row custom-row-gap">
              <div className="col-xl-8 ">
                <div className="about-page-content">
                  <h5 className="mb-20 title-style-2 fix-width-post-content">
                    Welcome to Exploreist: Unveiling the through My Lens!
                  </h5>
                  <p className="mb-30 fix-width-post-content">
                    Hello, fellow wanderers! I'm Mike Aiden, the creator and
                    explorer behind this personal travel blog. Embarking on a
                    journey of self-discovery, I discovered a profound passion
                    for unravelling the world's mysteries, one destination at a
                    time.
                  </p>

                  <p className="mb-lg-60 mb-40 fix-width-post-content">
                    At Exploreist, we believe that travel is not just about
                    visiting new places; it's a transformative experience that
                    leaves an indelible mark on the soul. Our mission is to
                    inspire and guide you on your own odyssey of discovery,
                    providing insights into hidden gems, cultural nuances, and
                    the beauty that lies off the beaten path.
                  </p>

                  <div className="position-relative pb-70 mb-lg-60 mb-30">
                    <div className="about-post-image">
                      <img
                        src="assets/images/blog/explore-image-24.jpg"
                        alt="blog-image"
                    ...
                    <div className="counter-wrapper">
                      <div className="counter-number">
                        <h6 className="odometer" data-count="129">
                      ...
                      <div className="counter-number">
                        <h6 className="odometer" data-count="30">
                          {subscribers}
                        </h6>
                        <h5>k+</h5>
                  ...
                  <p className="fix-width-post-content">
                    Exploreist is not just a collection of travel tales; it's a
                    curated space where each story is a brushstroke in the
                    vibrant painting of our global adventures. We dive into the
                    heart of destinations, capturing the essence of diverse
                    landscapes, local flavours, and the magic that happens when
                    cultures collide.
                  </p>
                  ...
                  <ul className="mb-lg-60 mb-30 fix-width-post-content">
                    <li>
                      <p>
                        {" "}
                        <span className="fw-bold">Authentic Narratives:</span>
                        Our stories are genuine and unfiltered, sharing both the
                        highs and lows of our travel escapades.
                      </p>
                    </li>
                    <li>
                      <p>
                        {" "}
                        <span className="fw-bold">Local Insights:</span>
                        Beyond the tourist hotspots, we delve into the heart of
                        communities, forging connections and celebrating the
                        rich tapestry of global cultures.
                      </p>
                    </li>
                    <li>
                      <p>
                        {" "}
                        <span className="fw-bold">Practical Tips:</span>
                        From travel hacks to must-visit spots, we offer
                        practical advice to enhance your journeys and make them
                    ...
                    <li>
                      <p>
                        {" "}
                        <span className="fw-bold">Photography Showcase:</span>
                        Immerse yourself in the visual feast of our travels.
                        Every image is a testament to the breathtaking beauty
                        that awaits you around the world.
                      </p>
                    </li>
                  </ul>
                  <h5 className="mb-20 title-style-2 fix-width-post-content">
                  ...
                  <p className="mb-20 fix-width-post-content">
                    Beyond the blog, we invite you to be a part of our travel
                    tribe. Share your own stories, ask questions, and connect
                    with like-minded explorers. Let's build a community that
                    celebrates the diverse tapestry of our global adventures.
                  </p>
                  <p className="mb-20 fix-width-post-content">
                    Thank you for joining us on this incredible journey. Whether
                    you're an avid traveler or an armchair explorer, there's a
                    place for you at [Your Blog Name]. Here's to countless more
                    miles, experiences, and stories waiting to unfold.
                  </p>
              ...
              <div className="col-xl-4">
                <div className="sticky-elements">
                  ...
                  {/* <!-- sidebar socials --> */}
                  <div
                    className="widget widget-style-2 mb-lg-60 mb-30  wow fadeInUp"
                    data-wow-delay="0.4s"
                  >
                  ...
                  {/* <!-- catagory --> */}
                  <div
                    className="catagory mb-lg-60 mb-30 wow fadeInUp"
                    data-wow-delay="0.4s"
                  >
