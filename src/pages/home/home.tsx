                      ...
                      <div className="d-flex flex-column gap-60">
                        ...
                        >
                          ...
                          <p className="mb-4 mb-lg-30">
                            Make sure to subscribe to our newsletter and be
                            first to get latest updates and news.
                          </p>
                        ...
                        <div
                          ...
                          data-wow-delay="0.3s"
                        >
                          <h4 className="fs-1 mb-3 mb-lg-30 text-white">
                            Lets Talk
                          </h4>
                          <p className="mb-20 mb-lg-40 text-white">
                            We are a team always open to discuss your project
                ...
                <div className="d-flex flex-column">
                  ...
                  {blogs &&
                    ...
                    blogs.slice(4).map((blog, index) => {
                      return (
                        <Reveal
                          keyframes={index % 2 === 0 ? backInLeft : backInRight}
                          duration={750}
                          triggerOnce
                        >
                          <div
                            ...
                            <div className="card-body">
                              <div className="card-header text-uppercase">
                                <Link
                                  ...
                                  className="fs-6 card-header-title"
                                >
                                  {blog.category}
                                </Link>
                              </div>
          ...
          <div className="container">
            <div className="d-flex flex-column gap-30">
              <div className="widget widget-style-1">
                <h4 className="fs-1 mb-3 mb-lg-20">Newsletter</h4>
                <p className="mb-4 mb-lg-30">
                  Make sure to subscribe to our newsletter and be first to get
              ...
              >
                ...
                <p className="mb-20 mb-lg-40 text-white">
                  We are a team always open to discuss your project and improve
