...
import {
  toastMessageError,
  toastMessageSuccess,
} from "../../components/utilities/commonToast/CommonToastMessage";
...
const Article = () => {
  ...
  const [viewReplyCommentIndex, setViewReplyCommentIndex] =
    useState<number>(-1);
  ...
  const [mainSwiper, setMainSwiper] = useState<SwiperType | undefined>(
    undefined
  );
  ...
  const replyData = async (comment_id: number) => {
    ...
    const response = await GetAllComments(
      ...
      comment_id as unknown as number
    );
  ...
  const handleClick = async () => {
    const response = await Reacted(
      { blog_id: blog?.id, user_id: blog?.user_id } as LikeSchema,
      token as string
    );
    if (response.success) {
  ...
  useEffect(() => {
    document.querySelectorAll("[data-image]").forEach((element) => {
      ...
      const imageUrl = htmlElement.getAttribute("data-image");
      if (imageUrl) {
    ...
    <div className="page">
      ...
      >
        ...
        <section className="section-banner article-1 position-relative">
          <div
            className="article-wrapper article-wrapper-1 mx-auto position-relative parallax"
            data-image={blog?.mainImage}
            style={{
              backgroundImage: `url(${blog?.mainImage})`, // Dynamic image URL
              ...
              <div className="col-xl-7">
                ...
                <div className="article-blog-content mb-lg-0 mb-20">
                                  ...
                                  <li>
                                    <h4>
                                      ...
                                      <a href="#Camping-by-the-Shores">
                                        Camping by the Shores - Sleeping Under
                                        the Alaskan Stars
                                      </a>
                                    </h4>
                                  </li>
                                  <li>
                                    <h4>
                                      <a href="#Wildlife-Safari">
                                        Wildlife Safari - Encounters with
                                        Alaska's Untamed Residents
                                      </a>
                                    </h4>
                                  </li>
                                </ul>
                  ...
                  >
                    ...
                    <p className="pb-20 pb-lg-30 ">{blog?.introduction}</p>
                    {/* quote */}
                    ...
                    <p className="pb-20 pb-lg-30 ">
                      In this blog post, I share all that we got to see, do, and
                      learn on this epic adventure, as well as a review of
                      Alaska Alpine Adventures for those of you looking to
                    ...
                    <ul className="">
                      <p className="pb-20 pb-lg-30 ">
                        Here are some travel tips and hacks that we learned on
                        our trip:
                        {blog?.tips}
                      </p>
                    </ul>
                    <p className="mb-20 mb-lg-30">
                      ...
                      well-prepared to be immerse yourself in the natural beauty
                      and tranquillity of Lake Clark, creating memories that
                      will last a lifetime. //todo
                    </p>
                    ...
                    <p className="mb-lg-30 mb-20 ">{blog?.adventure}</p>
                      ...
                      <div className="single-article-post-grid">
                        ...
                        <div className="single-article-post-content">
                          <div className="single-article-post-style">
                            ...
                            >
                              Kayaking Chronicles - Paddling through Pristine
                              Waters
                            </h4>
                            <p className="mb-lg-20 mb-10">
                              Embark on an exhilaarataing journey through the
                              Kayaking Chronicles of Lake Clark, where is the
                              crystal-clear waters beckons adventure seekers to
                              paddle through pristine landscape. The allure of
                              the Lake Clark lies not just in its transparency
                              but in the sereeeeeenity that is envelops each
                              stroke. The Lake Clark's Hiking Havens
                              adventureres into an untou realm of rugged beauty.
                            </p>
                            <h4
                              id="hiking-havens"
                            ...
                            <p className="mb-lg-20 mb-10">
                              Lake Clark's Hiking Havens beckon adventure into
                              an untouched realm of ruggded beauty. Trails wind
                              through vasted tundra, revealing breathtaking
                              vistats of snow-capped peaks and pristine
                              lakes.snow-capped peaks and pristine lakes.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <p className="pb-20 ">
                      Experience the magic of camping along Lake Clark's
                      pristine shores. Set up your tent under Alaskan sky, where
                      the midnight sun illuminates rugged landscapes, creating
                    ...
                    <p className="mb-lg-30 mb-10">
                      Experience the magic of camping along Lake Clark's
                      pristine shores. Set up your tent under the vast Alaskan
                      sky, where the midnight sun illuminates rugged landscapes,
                      creating unforgettable lakeside memories.
                    </p>
                    <h4
                      id="Wildlife-Safari"
                      className="mb-10 article-post-sub-heading "
                    >
                      Wildlife Safari - Encounters with Alaska's Untamed
                      Residents
                    </h4>
                    <p className="mb-lg-60 mb-md-30 mb-10">
                      Embark on a wildlife safari at The Lake Clark, Alaska,
                      where is untamed brown bear roam freely, eagles soar
                      overhead, and moose graze by the shores—a captivating
                      envvcounter with Alaska's wild residents. Lake Clark, a
                      haven for outdoor enthusiasts, pristine waters to know
                      summiting majestic peaks, it's an untamed adventure etched
                      ...
                      <div className="swiper article-slider-wrapper">
                        ...
                        >
                          {blog?.photos?.map((photo, index) => (
                            <SwiperSlide
                              key={index}
                              className="border-rarius-14 article-slider-single"
                            >
                              <img
                                className="border-rarius-14"
                                src={photo}
                          ...
                          <div className="swiper article-slider-thumb-wrapper">
                            ...
                            >
                              {blog?.photos?.map((image, index) => (
                                <SwiperSlide
                                  key={index}
                                  className="article-slider-thumb-single"
                                >
                                  <img
                                    src={image}
                    ...
                    <div className="google-map pb-40">
                      <MyMap
                        center={[
                          blog?.latitude as number,
                          blog?.longitude as number,
                        ]}
                        zoom={3}
                        pinCoordinates={[
                          blog?.latitude as number,
                    ...
                    <p className="mb-lg-20 mb-10">{blog?.travelChallenges}</p>
                    ...
                    <p className="mb-lg-60  mb-30">{blog?.conclusion}</p>
                  </div>
                  {/* article content */}
                </div>
                            ...
                            <div className="d-flex gap-20">
                              ...
                              <div className="comment-content">
                                ...
                                <span className="timestamp">
                                  January 12,{" "}
                                  <span className="dynamic-year"></span>. at
                                  10am
                                </span>
                                <p>{comment.text}</p>
                                <div
                              ...
                              <div className="reply mb-30 mt-2">
                                <div className="d-flex gap-20">
                                  ...
                                  >
                                    ...
                                    {replyErrors && replyErrors.text && (
                                      <div>{replyErrors.text.message}</div>
                                    )}
                                  </form>
                                </div>
                              </div>
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          <p className="card-text small">
                            Nature Peaceful Miracle captivate with serene
                            reflection, gentle ripples, and harmonious symphony.
                            A tranquil haven where beauty meets tranquility...
                          </p>
                        </div>
                      </div>
                    </div>
